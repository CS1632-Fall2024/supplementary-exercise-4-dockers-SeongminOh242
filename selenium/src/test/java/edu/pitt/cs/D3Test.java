...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    String expectedUrl = driver.getCurrentUrl() + "reset";
    assertEquals(vars.get("reset").toString(), expectedUrl);
  }
  ...
  public void tEST3CATALOG() {
    ...
    String expectedUrl = driver.getCurrentUrl() + "images/cat2.jpg";
    assertEquals(vars.get("picture").toString(), expectedUrl);
  }
  ...
  public void tEST9FEED() {
    driver.get("https://cs1632.appspot.com/");
    driver.manage().window().setSize(new Dimension(1512, 823));
    js.executeScript("document.cookie = \"1=false\";document.cookie = \"2=false\";document.cookie = \"3=false\";");
    driver.findElement(By.linkText("Feed-A-Cat")).click();
